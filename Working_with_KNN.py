...
#L1
distance = tf.reduce_sum(tf.abs(tf.subtract(x_data_train, tf.expand_dims(\
    x_data_test, 1))), reduction_indices=2)
"""
L2
distance = tf.sqrt(tf.reduce_sum(tf.square(tf.subtract(x_data_train, tf.expand_dims(\
x_data_test, 1))), reduction_indices=1))
"""
