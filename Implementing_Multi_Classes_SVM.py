...
for i in range(iterations):
    ...
    batch_accuracy.append(sess.run(accuracy, feed_dict={x_data:rand_x, y_target:rand_y, prediction_grid:rand_x}))
...
grid_predictions = sess.run(prediction, feed_dict={x_data:rand_x, y_target:rand_y,\
